...
export default function CategoryPage() {
    ...
    const categoryImageList = [
        ...
        const categoryTextList = [   
            ...
            "heartE","heartF","heartE","heartE","heartE",
            "heartF","heartF","heartF","heartF","heartF" ]
            //Uses this array to propagate the table with category descriptions

    function listCreator(numberOfRows, images, text) {
        ...
        for(let i=0;i<numberOfRows;i++) {
            list.push(<RowCard position={i} image={images} title={text}></RowCard>)
        }
        return list;
    }
        ...
        <div> 
            ...
            <Grid>
                ...
                <Box>
                    ...
                    <Grid >
                        <Box>
                                ...
                                <div className="SecretSauce"> 
                                    <Box width={["6.25px","12.5px","25px","50px"]}></Box>
                                    <Box>  
                                        <Text className="title"   fontFamily="Roboto" fontSize={["30px","30px","30px","50px"]}>Categories</Text>     
                                    </Box>
                                </div>
                        </Box>
                        {/* Horizontal Line*/}
                    ...
                    {/* Part II: Category Icon Pairs. Uses function above*/}
            <Flex className="containerDown">
                { listCreator(3, categoryImageList, categoryTextList) }
            </Flex>
            </div>
    );
}
