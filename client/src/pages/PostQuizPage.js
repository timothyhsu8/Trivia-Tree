    ...
    if (loading) {
        return (
            <Box height='auto'>
                ...
                <h1 className='center button white'>
                    "Here's a picuture of the moon while you wait!"
                </h1>
                <Box h='200px'></Box>
            </Box>
            ...
            <Box>
                ...
                <Box className='containerDown'>
                    ...
                    <Box className='containerAcross'>
                        ...
                        <Box className='containerDown'>
                            {/* Statbox */}
                            <Box ml='50px' w='400px' h='50px' bg='gray'>
                                {' '}
                            ...
                            <Box ml='50px' w='400px' h='450px' bg='#D3D3D3'>
                                {' '}
