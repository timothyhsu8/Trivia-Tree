...
export default function ChooseCategoryCard( props ) {
    ...
    return (
        ...
        >
            <Image value={category.name} alt={category.name} h="65px" w="65px" bgColor={ props.categoriesSelected.includes(category.name) ? "blue.100":""} src={category.icon} borderRadius={5} padding="7px" _hover={{bgColor:"blue.100", borderRadius:5, cursor:"pointer"}}/>  
